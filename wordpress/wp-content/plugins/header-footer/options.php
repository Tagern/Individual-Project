...
<div class="wrap">
    ...
    <div style="padding: 15px; background-color: #fff; border: 1px solid #eee; font-size: 16px; line-height: 22px">
        Did this plugin save you of time and troubles?    
            ...
            <div class="panel-container">
                ...
                <div id="tabs-first">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <?php hefo_base_checkbox('mobile_footer', __('Mobile', 'header-footer')); ?><br>
                    ...
                    <?php for ($i = 1; $i < 4; $i++) { ?>
                        ...
                        <p>Inject before the <?php hefo_base_text('generic_tag_' . $i); ?> code</p>
                        <div class="row">
                            <div class="col-2">
                ...
                <div id="tabs-post-inner">
                    ...
                    <?php for ($i = 1; $i < 4; $i++) { ?>
                        <h3>Inner injection <?php echo $i; ?></h3>
                        <?php hefo_rule($i); ?>
                        <div class="row">
                            <div class="col-2">
                                Desktop (and mobile if no alternative specified)<br>
